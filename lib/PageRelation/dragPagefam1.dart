...
import 'package:gladd/PageRelation/dragPagefam2.dart';
...
class DragPagefam1 extends StatefulWidget {
  @override
  _DragPagefam1State createState() => _DragPagefam1State();
}

class _DragPagefam1State extends State<DragPagefam1> {
                ...
                GestureDetector(
                  onTap: (){
                    Navigator.of(context).pushReplacement(
                        MaterialPageRoute(builder: (_) => DragPagefam2()));
                  },
                  child: Container(
...
final allAnimals = [
  _Animals2(
    type: _AnimalType.C,
    imageUrl: 'assets/relation/auntplay.gif',
  ),
  _Animals2(
    type: _AnimalType.D,
    imageUrl: 'assets/relation/uncleplay.gif',
  ),
];
