...
import 'package:gladd/RealtionMaster.dart';
...
class DragPagefam2 extends StatefulWidget {
  @override
  _DragPagefam2State createState() => _DragPagefam2State();
}

class _DragPagefam2State extends State<DragPagefam2> {
                ...
                GestureDetector(
                  onTap: (){
                    Navigator.of(context).pushReplacement(
                        MaterialPageRoute(builder: (_) => RelationMaster()));
                  },
                  child: Container(
...
final allAnimals = [
  _Animals2(
    type: _AnimalType.C,
    imageUrl: 'assets/relation/grandma_play.gif',
  ),
  _Animals2(type: _AnimalType.D, imageUrl: 'assets/relation/grandpaplay.gif'),
];
