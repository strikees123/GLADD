...
class Relation extends StatefulWidget {
  ...
  @override
  RelationState createState() => RelationState();
}
...
class RelationState extends State<Relation> {
  ...
  List<String> imgList = [
    "assets/relation/father.gif",
    "assets/relation/mother.gif",
    "assets/relation/brother.gif",
    "assets/relation/sister.gif",
    "assets/relation/grandpa.gif",
    "assets/relation/grandma_word.gif",
    "assets/relation/aunt.gif",
    "assets/relation/uncle.gif",
  ];
      ...
      appBar: AppBar(
        leading: IconButton(
          ...
          onPressed: () => (Navigator.of(context).pushReplacement(
            MaterialPageRoute(builder: (_) => LPRelation()),
          )), // button pressed
        ),
        centerTitle: true,
        title: Text("FAMILY ", style: GoogleFonts.lato(textStyle: style)),
      ),
      body: Container(
        child: Column(
