...
class DragPagecolor3 extends StatefulWidget {
  @override
  _DragPagecolor3State createState() => _DragPagecolor3State();
}

class _DragPagecolor3State extends State<DragPagecolor3> {
