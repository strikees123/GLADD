...
import 'package:gladd/ColorMaster.dart';
...
class DragPagecolor2 extends StatefulWidget {
  @override
  _DragPagecolor2State createState() => _DragPagecolor2State();
}

class _DragPagecolor2State extends State<DragPagecolor2> {
                ...
                GestureDetector(
                  onTap: (){
                    Navigator.of(context).pushReplacement(
                        MaterialPageRoute(builder: (_) => ColorMaster()));
                  },
                  child: Container(
...
final allAnimals = [
  _Animals2(
    type: _AnimalType.C,
    imageUrl: 'assets/Color/green_play.gif',
  ),
  _Animals2(type: _AnimalType.D, imageUrl: 'assets/Color/yellow_play.gif'),
];
