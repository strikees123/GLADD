...
import 'package:gladd/Pageexpression/dragPageexp2.dart';
...
class DragPageexp1 extends StatefulWidget {
  @override
  DragPageexp1State createState() => DragPageexp1State();
}

class DragPageexp1State extends State<DragPageexp1> {
                ...
                GestureDetector(
                  onTap: (){
                    Navigator.of(context).pushReplacement(
                        MaterialPageRoute(builder: (_) => DragPageexp2()));
                  },
                  child: Container(
...
final allAnimals = [
  _Animals2(
    type: _AnimalType.C,
    imageUrl: 'assets/expressions/happy_play.gif',
  ),
  _Animals2(
    type: _AnimalType.D,
    imageUrl: 'assets/expressions/sad-play.gif',
  ),
];
