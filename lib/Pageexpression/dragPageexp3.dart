// @dart=2.9
import 'package:gladd/ExpMaster.dart';
...
class DragPageexp3 extends StatefulWidget {
  @override
  _DragPageexp3State createState() => _DragPageexp3State();
}

class _DragPageexp3State extends State<DragPageexp3> {
                ...
                GestureDetector(
                  onTap: (){
                    Navigator.of(context).pushReplacement(
                        MaterialPageRoute(builder: (_) => ExpMaster()));
                  },
                  child: Container(
...
final allAnimals = [
  _Animals2(
    type: _AnimalType.C,
    imageUrl: 'assets/expressions/cry_play.gif',
  ),
  _Animals2(type: _AnimalType.D, imageUrl: 'assets/expressions/angry_play.gif'),
];
