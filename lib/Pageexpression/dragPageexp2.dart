...
import 'package:gladd/Pageexpression/dragPageexp3.dart';
...
class DragPageexp2 extends StatefulWidget {
  @override
  _DragPageexp2State createState() => _DragPageexp2State();
}

class _DragPageexp2State extends State<DragPageexp2> {
                ...
                GestureDetector(
                  onTap: (){
                    Navigator.of(context).pushReplacement(
                        MaterialPageRoute(builder: (_) => DragPageexp3()));
                  },
                  child: Container(
...
final allAnimals = [
  _Animals2(
    type: _AnimalType.C,
    imageUrl: 'assets/expressions/sick_play.gif',
  ),
  _Animals2(
      type: _AnimalType.D, imageUrl: 'assets/expressions/hungry_play.gif'),
];
