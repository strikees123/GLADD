...
import 'package:gladd/PageAnimals/dragPageanim2.dart';
...
class DragPageanim1 extends StatefulWidget {
  @override
  _DragPageanim1State createState() => _DragPageanim1State();
}

class _DragPageanim1State extends State<DragPageanim1> {
                ...
                GestureDetector(
                  onTap: (){
                    Navigator.of(context).pushReplacement(
                        MaterialPageRoute(builder: (_) => DragPageanim2()));
                  },
                  child: Container(
...
final allAnimals = [
  _Animals2(
    type: _AnimalType.C,
    imageUrl: 'assets/animal/cat_play.gif',
  ),
  _Animals2(
    type: _AnimalType.D,
    imageUrl: 'assets/animal/dog_play.gif',
  ),
];
