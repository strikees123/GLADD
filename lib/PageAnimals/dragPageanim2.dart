// @dart=2.9
import 'package:gladd/AnimalMaster.dart';
...
class DragPageanim2 extends StatefulWidget {
  @override
  _DragPageanim2State createState() => _DragPageanim2State();
}

class _DragPageanim2State extends State<DragPageanim2> {
                ...
                GestureDetector(
                  onTap: (){
                    Navigator.of(context).pushReplacement(
                        MaterialPageRoute(builder: (_) => AnimalMaster()));
                  },
                  child: Container(
...
final allAnimals = [
  _Animals2(
    type: _AnimalType.C,
    imageUrl: 'assets/animal/cow_play.gif',
  ),
  _Animals2(type: _AnimalType.D, imageUrl: 'assets/animal/duck_play.gif'),
];
