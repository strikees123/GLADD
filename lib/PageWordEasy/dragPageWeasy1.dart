...
import 'package:gladd/PageWordEasy/dragPageWeasy2.dart';
...
class DragPagewEasy1 extends StatefulWidget {
  @override
  _DragPagewEasy1State createState() => _DragPagewEasy1State();
}

class _DragPagewEasy1State extends State<DragPagewEasy1> {
                ...
                GestureDetector(
                  onTap: (){
                    Navigator.of(context).pushReplacement(
                        MaterialPageRoute(builder: (_) => DragPagewEasy2()));
                  },
                  child: Container(
...
final allAnimals = [
  _Animals2(
    type: _AnimalType.C,
    imageUrl: 'assets/images/boy_gif.gif',
  ),
  _Animals2(
    type: _AnimalType.D,
    imageUrl: 'assets/images/girl_gif.gif',
  ),
];
