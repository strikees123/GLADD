...
import 'package:gladd/WordsEasyMaster.dart';
...
class DragPagewEasy3 extends StatefulWidget {
  @override
  _DragPagewEasy3State createState() => _DragPagewEasy3State();
}

class _DragPagewEasy3State extends State<DragPagewEasy3> {
                ...
                GestureDetector(
                  onTap: (){
                    Navigator.of(context).pushReplacement(
                        MaterialPageRoute(builder: (_) => WeasyMaster()));
                  },
                  child: Container(
...
final allAnimals = [
  _Animals2(
    type: _AnimalType.C,
    imageUrl: 'assets/images/up_gif.gif',
  ),
  _Animals2(type: _AnimalType.D, imageUrl: 'assets/images/down_gif.gif'),
];
