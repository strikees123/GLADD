...
import 'package:gladd/page/dragPage2.dart';
...
class DragPage1 extends StatefulWidget {
  @override
  _DragPage1State createState() => _DragPage1State();
}

class _DragPage1State extends State<DragPage1> {
                ...
                GestureDetector(
                  onTap: (){
                    Navigator.of(context).pushReplacement(
                        MaterialPageRoute(builder: (_) => DragPage2()));
                  },
                  child: Container(
...
final allAnimals = [
  _Animals2(
    type: _AnimalType.C,
    imageUrl: 'assets/alpha/handa.jpg',
  ),
  _Animals2(type: _AnimalType.D, imageUrl: 'assets/alpha/handb.jpg'),
];
