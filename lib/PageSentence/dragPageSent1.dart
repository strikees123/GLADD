...
import 'package:gladd/PageSentence/dragPageSent2.dart';
...
class DragPageSent1 extends StatefulWidget {
  @override
  _DragPageSent1State createState() => _DragPageSent1State();
}

class _DragPageSent1State extends State<DragPageSent1> {
                ...
                GestureDetector(
                  onTap: (){
                    Navigator.of(context).pushReplacement(
                        MaterialPageRoute(builder: (_) => DragPageSent2()));
                  },
                  child: Container(
...
final allAnimals = [
  _Animals2(
    type: _AnimalType.C,
    imageUrl: 'assets/sentence/comehere_gif.gif',
  ),
  _Animals2(
    type: _AnimalType.D,
    imageUrl: 'assets/sentence/goodnight_gif.gif',
  ),
];
