...
import 'package:gladd/SentenceMaster.dart';
...
class DragPageSent2 extends StatefulWidget {
  @override
  _DragPageSent2State createState() => _DragPageSent2State();
}

class _DragPageSent2State extends State<DragPageSent2> {
                ...
                GestureDetector(
                  onTap: (){
                    Navigator.of(context).pushReplacement(
                        MaterialPageRoute(builder: (_) => SentMaster()));
                  },
                  child: Container(
...
final allAnimals = [
  _Animals2(
    type: _AnimalType.C,
    imageUrl: 'assets/sentence/wakeup_gif.gif',
  ),
  _Animals2(type: _AnimalType.D, imageUrl: 'assets/sentence/washhands_gif.gif'),
];
