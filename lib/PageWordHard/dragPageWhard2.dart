...
import 'package:gladd/PageWordHard/dragPageWhard3.dart';
...
class DragPagewHard2 extends StatefulWidget {
  @override
  _DragPagewHard2State createState() => _DragPagewHard2State();
}

class _DragPagewHard2State extends State<DragPagewHard2> {
                ...
                GestureDetector(
                  onTap: (){
                    Navigator.of(context).pushReplacement(
                        MaterialPageRoute(builder: (_) => DragPagewHard3()));
                  },
                  child: Container(
...
final allAnimals = [
  _Animals2(
    type: _AnimalType.C,
    imageUrl: 'assets/wordhard/careful_gif.gif',
  ),
  _Animals2(type: _AnimalType.D, imageUrl: 'assets/wordhard/door_gif.gif'),
];
