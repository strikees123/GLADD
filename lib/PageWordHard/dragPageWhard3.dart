...
import 'package:gladd/WordsHardMaster.dart';
...
class DragPagewHard3 extends StatefulWidget {
  @override
  _DragPagewHard3State createState() => _DragPagewHard3State();
}

class _DragPagewHard3State extends State<DragPagewHard3> {
                ...
                GestureDetector(
                  onTap: (){
                    Navigator.of(context).pushReplacement(
                        MaterialPageRoute(builder: (_) => WhardMaster()));
                  },
                  child: Container(
...
final allAnimals = [
  _Animals2(
    type: _AnimalType.C,
    imageUrl: 'assets/wordhard/house_gif.gif',
  ),
  _Animals2(type: _AnimalType.D, imageUrl: 'assets/wordhard/water_gif.gif'),
];
