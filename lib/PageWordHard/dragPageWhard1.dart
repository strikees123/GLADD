...
import 'package:gladd/PageWordHard/dragPageWhard2.dart';
...
class DragPagewHard1 extends StatefulWidget {
  @override
  _DragPagewHard1State createState() => _DragPagewHard1State();
}

class _DragPagewHard1State extends State<DragPagewHard1> {
                ...
                GestureDetector(
                  onTap: (){
                    Navigator.of(context).pushReplacement(
                        MaterialPageRoute(builder: (_) => DragPagewHard2()));
                  },
                  child: Container(
...
final allAnimals = [
  _Animals2(
    type: _AnimalType.C,
    imageUrl: 'assets/wordhard/bed_gif.gif',
  ),
  _Animals2(
    type: _AnimalType.D,
    imageUrl: 'assets/wordhard/bicycle_gif.gif',
  ),
];
