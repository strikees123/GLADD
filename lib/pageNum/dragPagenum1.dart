...
import 'package:gladd/pageNum/dragPagenum2.dart';
import 'package:google_fonts/google_fonts.dart';


class DragPagenum1 extends StatefulWidget {
  @override
  _DragPagenum1State createState() => _DragPagenum1State();
}

class _DragPagenum1State extends State<DragPagenum1> {
                ...
                GestureDetector(
                  onTap: (){
                    Navigator.of(context).pushReplacement(
                        MaterialPageRoute(builder: (_) => DragPagenum2()));
                  },
                  child: Container(
...
final allAnimals = [
  _Animals2(
    type: _AnimalType.C,
    imageUrl: 'assets/number/hand1.jpg',
  ),
  _Animals2(
    type: _AnimalType.D,
    imageUrl: 'assets/number/hand2.jpg',
  ),
];
