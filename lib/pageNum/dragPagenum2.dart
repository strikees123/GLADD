...
import 'package:gladd/pageNum/dragPagenum3.dart';
import 'package:google_fonts/google_fonts.dart';


class DragPagenum2 extends StatefulWidget {
  @override
  _DragPagenum2State createState() => _DragPagenum2State();
}

class _DragPagenum2State extends State<DragPagenum2> {
                ...
                GestureDetector(
                  onTap: (){
                    Navigator.of(context).pushReplacement(
                        MaterialPageRoute(builder: (_) => DragPagenum3()));
                  },
                  child: Container(
...
final allAnimals = [
  _Animals2(
    type: _AnimalType.C,
    imageUrl: 'assets/number/hand4.jpg',
  ),
  _Animals2(type: _AnimalType.D, imageUrl: 'assets/number/hand5.jpg'),
];
