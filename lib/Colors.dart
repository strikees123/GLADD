...
class LearnColor extends StatefulWidget {
  LearnColor() : super();

  @override
  LearnColorState createState() => LearnColorState();
}

class LearnColorState extends State<LearnColor> {
  //
  ...
  List<String> imgList = [
    "assets/Color/blue_word.gif",
    "assets/Color/green_word.gif",
    "assets/Color/orange_word.gif",
    "assets/Color/red_word.gif",
    "assets/Color/white_word.gif",
    "assets/Color/yellow_word.gif"
  ];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text("COLOURS", style: GoogleFonts.cinzel(textStyle: style)),
      ),
      body: Container(
        child: Column(
